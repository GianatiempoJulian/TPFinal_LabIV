<nav>
    <img src="<?php echo IMG_PATH?>logo_placeholder.png" alt="logo">
        <ul>
            <li><a href="<?php echo FRONT_ROOT ?>Administrator/showAdministratorProfile">Mi Perfil</a></li>
            <li>|</li>

            <li><a href="<?php echo FRONT_ROOT ?>Administrator/showAddView">Agregar Usuario</a></li>
            <li>|</li>
