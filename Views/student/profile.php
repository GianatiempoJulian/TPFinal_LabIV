        ...
        <div class="user-profile-container">
            <div class="img-container">
             ...
             <div>
                ...
                <h5><?php echo $careerFromStudent->getDescription() ?></h5>
             </div>
             <div class="user-profile-options">
                <a href="<?php echo FRONT_ROOT?>Student/showOfferStudent/<?php echo $student->getRecordId()?>">Empleos Solicitados</a>
             </div>
             <div>
             </div>
             <ul class="user-profile-data">
                <li><?php echo "ID: ". $student->getRecordId() ?></li>
